...
namespace lista4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //"é verdadeira, pois o proprio programa realiza a conversão das variáveis, por exemplo:" +
            ...
            //exerc3
            // se o valor digitado pelo usuário é condizente ao tipo de variavel, caso contrario o codigo não irá funcionar.
